function VarName6 = getnchannels(filename, startRow, endRow)
%IMPORTFILE1 Import numeric data from a text file as column vectors.
%   VARNAME6 = IMPORTFILE1(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   VARNAME6 = IMPORTFILE1(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   VarName6 = importfile1('2012_1220sys02sync1.meta',8, 8);
%
%    See also TEXTSCAN.

% Auto-generated by Jay on 2013/02/04 16:35:40
